...
export const API_REGISTRY = {
  ...
  globaldata: {
    ...
    auctionType: { url: '/api/globaldata/auction-types', matchField: 'name', globaldata: true },
    ...
    basePriceSetting: { url: '/api/globaldata/base-price-settings', matchField: 'name', globaldata: true },
    bidDifferenceType: { url: '/api/globaldata/bid-difference-types', matchField: 'name', globaldata: true },
    billingQtyBasis: { url: '/api/globaldata/billing-qty-basis', matchField: 'billingQtyBasisName', globaldata: true },
    budgetType: { url: '/api/globaldata/budget-types', matchField: 'name', globaldata: true },
    ...
    extensionType: { url: '/api/globaldata/extension-types', matchField: 'name', globaldata: true },
    forms: { url: '/api/globaldata/forms', matchField: 'formCaption', globaldata: true },
    formsMenu: { url: '/api/globaldata/forms/menu', matchField: 'name', globaldata: true },
    ...
    negotiationOn: { url: '/api/globaldata/negotiation-on', matchField: 'name', globaldata: true },
    ...
    reports: { url: '/api/globaldata/reports', matchField: 'reportName', globaldata: true },
