...
test.describe('CS API Tests', () => {

  test('should successfully create a CS payload', async ({ lookup, transactionPayloadHelper }) => {
    ...
    console.log("CS Payload:", JSON.stringify(payload, null, 2));
  ...
  test('should successfully create a custom CS payload using real data', async ({ PRApi, lookup, workflow, transactionPayloadHelper }) => {
    const payload = await transactionPayloadHelper.createPRPayload(lookup, {
