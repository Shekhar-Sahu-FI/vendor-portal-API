...
test.describe('Purchase Order API Tests', () => {
  ...
  test('should successfully create a Purchase Order payload', async ({ lookup, transactionPayloadHelper }) => {
  ...
  test('should successfully create a custom Purchase Order payload using real data', async ({ PRApi, lookup, workflow, transactionPayloadHelper }) => {
    const payload = await transactionPayloadHelper.createPRPayload(lookup, {
